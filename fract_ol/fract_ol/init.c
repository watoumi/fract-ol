...
/*   Updated: 2024/04/27 21:34:45 by wtoumi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void fractol_init(t_fractol *fractol) {
  ...
  if (NULL == fractol->mlx_connection)
    malloc_error();
  fractol->mlx_window =
      mlx_new_window(fractol->mlx_connection, WIDTH, HEIGHT, fractol->name);
  ...
  fractol->img.img_ptr =
      mlx_new_image(fractol->mlx_connection, WIDTH, HEIGHT);
  ...
  fractol->img.pixels_ptr =
      mlx_get_data_addr(fractol->img.img_ptr, &fractol->img.bpp,
